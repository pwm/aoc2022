...
import AoC.Puzzles.Y2022D22 qualified as Y2022D22
import AoC.Puzzles.Y2022D23 qualified as Y2022D23
import AoC.Puzzles.Y2022D24 qualified as Y2022D24
import AoC.Puzzles.Y2022D25 qualified as Y2022D25
...
solutions =
  Map.fromList
    [ ((2022, 01), mkSolverFor Y2022D01.parse Y2022D01.solveA Y2022D01.solveB),
      ...
      ((2022, 22), mkSolverFor Y2022D22.parse Y2022D22.solveA Y2022D22.solveB),
      ((2022, 23), mkSolverFor Y2022D23.parse Y2022D23.solveA Y2022D23.solveB),
      ((2022, 24), mkSolverFor Y2022D24.parse Y2022D24.solveA Y2022D24.solveB),
      ((2022, 25), mkSolverFor Y2022D25.parse Y2022D25.solveA Y2022D25.solveB)
    ]
